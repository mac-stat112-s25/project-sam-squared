...
Invasive_Species |>
  ...
  geom_bar() +
  coord_flip() +
  labs(x = "Invasive species name", y = "Count", title = "Distribution of invasive species sightings in Vermont (2007-2023)")
```
...
```
As this map makes clear, Hemlock Woolly Adelgid sightings were highly concentrated in Windham County until 2020. Since then, it has been spotted in various locations across the state. This is due to a large investation of HWA in Massachusets which borders the County.
