...
```{r}
#| fig-alt: "Stacked bar graph of invasive species in Vermont based on what condition the species was found in notably NA is most prevelant with Hemlock Wolly Adelgid being most prevelant in NA." 
...
Top_Invasive_Species |>
  ...
  ggtitle("Invasive Species Encounters by Life Stage")
  coord_flip() +
...
```{r}
#| fig-alt: " Bar graph of Hemlock Woolly Adelgid sightings in Vermont, by year with notable spikes in 2022 and 2016" 
...
Top_Invasive_Species |>
  ...
  ggplot(aes(x = year)) +
  geom_bar(color = "black") +
  ggtitle("Hemlock Woolly Adelgid Sightings in Vermont from 2007-2023") +
  coord_flip() +
...
```{r}
#| fig-width: 10
#| fig-alt: "Bar graph of Hemlock Woolly Adelgid sightings in Vermont showing a overwelming majority of visual survey sucess followed by unspeified and aeriel survey check"
