...
```
As this map makes clear, Hemlock Woolly Adelgid sightings were highly concentrated in Windham County until 2020. Since then, it has been spotted in various locations across the state. This is due to a large infestation of HWA in Massachusetts which borders the County. This follows the known history that HWA landed in southern New England on the winds of a hurricane in 1980 from more southern states

cite:https://www.umass.edu/agriculture-food-environment/landscape/fact-sheets/hemlock-woolly-adelgid-frequently-asked-questions
