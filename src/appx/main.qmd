...
```{r}
#ADD ALT TEXT (something like  scatter plot of vermont with colored dots deliniating time of sighting, there is a concentration of dots noting earlier sightings in south eastern Vermont and later dots showing spread to rest of Vermont.)
#ADD CAPTION
